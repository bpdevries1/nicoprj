...
proc main {argv} {
  ...
  set options {
    ...
    {outrootdir.arg "c:/projecten/Philips/Mobile-US/daily/graphs" "Directory for output graphs"}
    {pattern.arg "ZZZ" "Pattern of scripts to handle"}
    {outformat.arg "png" "Output format (all, png or svg)"}
    {loglevel.arg "info" "Log level (debug, info, warn)"}
    {combineddb.arg "c:/projecten/Philips/Mobile-US/daily/daily.db" "DB with combined data from all shops"}
