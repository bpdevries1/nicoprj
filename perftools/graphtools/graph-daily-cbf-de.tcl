...
proc main {argv} {
  ...
  set options {
    ...
    {outrootdir.arg "c:/projecten/Philips/CBF-DE/daily/graphs" "Directory for output graphs"}
    {pattern.arg "CBF-DE-*" "Pattern of scripts to handle"}
    {outformat.arg "png" "Output format (all, png or svg)"}
    {loglevel.arg "info" "Log level (debug, info, warn)"}
    {combineddb.arg "c:/projecten/Philips/CBF-DE/daily/daily.db" "DB with combined data from all shops"}
