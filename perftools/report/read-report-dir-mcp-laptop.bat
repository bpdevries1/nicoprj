...
tclsh read-report-dir.tcl -all -debug -dir c:/Projecten/Rabo/Testruns/MCPv3
rem tclsh read-report-dir.tcl -debug -dir c:/Projecten/Rabo/Testruns/MCPv3/ahk
rem tclsh read-report-dir.tcl -debug -dir c:/Projecten/Rabo/Testruns/MCPv3/vugen