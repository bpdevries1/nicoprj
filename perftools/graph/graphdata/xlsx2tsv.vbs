...
rem Remove .xlsx file extension if it was provided
dim ext
ext = right( oldfilename, 5 )
...
if pos > 0 then
 ...
 Wscript.echo "cmd.exe /c ren """ & oldfilename & ".xlsx"" " & newname & ".xlsx"
 oShell.run "cmd.exe /c ren """ & oldfilename & ".xlsx"" " & newname & ".xlsx"
...
dim wb
set wb = app.workbooks.open( filename_root & ".xlsx" )
