...
c:/nico/nicoprj/dbtools/dbscript.tcl -rootdir c:/projecten/Philips/KN-AN-Shop -dbpattern "keynotelogs.db" -script c:/nico/nicoprj/perftools/philips/tradedoubler.sql
