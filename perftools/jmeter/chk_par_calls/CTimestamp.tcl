...
itcl::class CTimestamp {
  ...
  public method is_datetime {a_datetime} {
	...
	# 09-07-06
	# 10-7-2006
	public method set_4nt_date {adate} {
		if {[regexp {^([0-9]{2})-([0-9]{2})-([0-9]{2})$} $adate z dd mm yy]} {
			set sec_date [clock scan $yy$mm$dd]
		} elseif {[regexp {^([0-9]{1,2})-([0-9]{1,2})-([0-9]{4})$} $adate z dd mm yyyy]} { 
			...
			log "ERROR: Could not parse 4nt_date: $adate" error timestamp
			set_null
		}
	}
