...
../dashboardtools/combinetables.tcl -dir c:/projecten/Philips/MyPhilips/daily -db daily.db -srcdir c:/projecten/Philips/KNDL -srcpattern "MyPhilips*" -tables "aggr_run,aggr_page,aggr_maxitem,aggr_slowitem,aggr_sub,pageitem_gt3" -droptarget 
../graphtools/graph-daily-myphilips.tcl -outformat png -actions "" -combinedactions "all" -pattern "XX"
