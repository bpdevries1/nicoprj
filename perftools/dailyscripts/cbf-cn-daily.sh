...
../dashboardtools/combinetables.tcl -dir c:/projecten/Philips/CBF-CN/daily -db daily.db -srcdir c:/projecten/Philips/KNDL -srcpattern "CBF-CN-*" -tables "aggr_run,aggr_page,aggr_maxitem,aggr_slowitem,aggr_sub,pageitem_gt3,pageitem_topic,domain_ip_time,aggr_specific" -droptarget 
../graphtools/graph-daily-cbf-cn.tcl -outformat png 
