...
../dashboardtools/combinetables.tcl -dir c:/projecten/Philips/CBF-CN/daily -db daily.db -srcdir c:/projecten/Philips/KNDL -srcpattern "CBF-CN-*" -tables "aggr_run,aggr_page,aggr_maxitem,aggr_sub" -droptarget 
