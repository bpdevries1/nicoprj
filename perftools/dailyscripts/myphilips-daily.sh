...
../dashboardtools/combinetables.tcl -dir c:/projecten/Philips/MyPhilips/daily -db daily.db -srcdir c:/projecten/Philips/KNDL -srcpattern "MyPhilips*" -tables "aggr_run,aggr_page,aggr_maxitem,aggr_sub" -droptarget 
