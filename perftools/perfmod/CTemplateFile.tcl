# @todo deze file nu ook in JMeter toolset, waar 'ie nieuwer is.
...
itcl::class CTemplateFile {
	...
	private common log
	# set log [CLogger::new_logger templatefile debug]
	...
	# private variable lqn_properties_filename
	...
	public method get_property {a_name} {
		return $ar_properties($a_name)
	}
