...
itcl::class CCalcCases {
	...
	public method handle_cases {lqns_control dirname result_dirname} {
		...
		# $lqns_control set_background_process_type NO_BG ; # BG_CLIENT, BG_SERVER
		$lqns_control lqns_control $dirname 0 [list 1 2 3 4 5 6 8 10] $template_filename $lqn_properties_filename $result_dirname Z0
		$lqns_control lqns_control $dirname 1.491 [list 1 2 3 4 5 6 8 10 20 50 100] $template_filename $lqn_properties_filename $result_dirname Z1
		$lqns_control lqns_control $dirname 14.91 [list 1 2 3 4 5 6 8 10 20 50 100 200 300 400 500 600 700] $template_filename $lqn_properties_filename $result_dirname Z10
	}
