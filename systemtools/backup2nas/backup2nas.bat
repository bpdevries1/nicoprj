...
tclsh backup-files.tcl -settingsdir "~/.backup2nas/laptop2nas" -t \\192.168.2.200\public\backups\DellLaptop -paths paths.txt -r results.txt -p -ignoreregexps ignoreregexps-programs.txt
