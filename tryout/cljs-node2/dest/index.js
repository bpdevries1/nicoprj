...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.type_satisfies_.call(null, cljs.core.IWithMeta, b)) : cljs.core.type_satisfies_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t5024 && (cljs.core.t5024 = {}, cljs.core.t5024 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta5025 = g;
    ...
    }, cljs.core.t5024.cljs$lang$type = !0, cljs.core.t5024.cljs$lang$ctorStr = "cljs.core/t5024", cljs.core.t5024.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t5024")
    }, cljs.core.t5024.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t5024.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(c.slice()))
    }, cljs.core.t5024.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t5024.prototype.cljs$core$Fn$ = !0, cljs.core.t5024.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta5025
    }, cljs.core.t5024.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t5024(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t5024 = function(b, c, f, g) {
      return new cljs.core.t5024(b, c, f, g)
    });
    return new cljs.core.t5024(c, b, with_meta, null)
...
var cljs_node2 = {core:{}};
cljs_node2.core.express = require("express");
cljs_node2.core.sqlite3 = require("sqlite3");
cljs_node2.core.mystr = "This is my string";
cljs_node2.core.open_db = function(a) {
  return new cljs_node2.core.sqlite3.Database(a)
};
cljs_node2.core.db_exec = function(a, b) {
  return a.serialize(function() {
    return a.run(b)
  })
};
cljs_node2.core.start = function() {
  var a = function(a) {
    cljs.core.println.call(null, "Server started on port 3000");
    cljs_node2.core.app = cljs_node2.core.express.call(null);
    cljs_node2.core.fs = require("fs");
    cljs_node2.core._STAR_rs_STAR_ = null;
    cljs_node2.core.app.get("/", function(a, b) {
      return b.send("Hello world!")
    });
    cljs_node2.core.app.get("/user/:name", function(a, b) {
      return b.send(a.params.name)
    });
    cljs_node2.core.app.get("/read", function(a, b) {
      cljs_node2.core._STAR_rs_STAR_ = cljs_node2.core.fs.createReadStream("testfile.txt");
      return cljs_node2.core._STAR_rs_STAR_.pipe(b)
    });
    cljs_node2.core.app.get("/dbread", function(a, b) {
      cljs_node2.core.mystr2 = cljs_node2.core.mystr;
      cljs_node2.core.db = cljs_node2.core.open_db.call(null, "testdb.db");
      cljs_node2.core.db_exec.call(null, cljs_node2.core.db, "CREATE TABLE IF NOT EXISTS Stuff (thing TEXT)");
      cljs_node2.core.db_exec.call(null, cljs_node2.core.db, "CREATE TABLE IF NOT EXISTS Stuff2 (thing TEXT)");
      cljs_node2.core.db_exec.call(null, cljs_node2.core.db, "insert into Stuff2 values ('Derde tekst')");
      cljs_node2.core.db.close();
      return b.send(cljs_node2.core.mystr2)
    });
    return cljs_node2.core.app.listen(3E3)
  }, b = function(b) {
    var d = null;
    0 < arguments.length && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = cljs_node2.core.start;
cljs.nodejs = {};
