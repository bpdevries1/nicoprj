landing() {
	...
	// [2016-12-06 16:30:14] autogenerator for Flat MI Submissions reporting.
/*Correlation comment - Do not change!  Original value='2001-01-01' Name ='FromDate' Type ='ResponseBased'*/
...
/*Correlation comment - Do not change!  Original value='9999-01-01' Name ='ToDate' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
...
/*Correlation comment - Do not change!  Original value='2016-11-01' Name ='FromDate_1' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
...
/*Correlation comment - Do not change!  Original value='2016-12-01' Name ='ToDate_1' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
	...
	web_url("menubar_mo.gif", 
		"URL=https://{domain}/RRS2/Content/Images/menubar_mo.gif", 
		"TargetFrame=", 
		"Resource=1", 
		"RecContentType=image/gif", 
		"Referer=https://{domain}/RRS2/", 
	...
	rb_end_transaction(transactie, TT);
	return 0;
}
